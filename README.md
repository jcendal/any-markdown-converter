...
<div align="center">
<img src="images/usage-context-menu.png" alt="Export from context menu — right-click on a .md file" width="450" />
</div>

A quick pick menu will appear with all available export formats:

<div align="center">
<img src="images/usage-format-selector.png" alt="Format selector — choose the output format" width="500" />
</div>
